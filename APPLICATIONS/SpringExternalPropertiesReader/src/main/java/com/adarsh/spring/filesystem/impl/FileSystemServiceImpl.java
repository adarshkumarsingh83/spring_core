...
public class FileSystemServiceImpl implements FileSystemService {
    ...
    private static final String rootDirName="application_home";
    private static final String rootDirChildName="home";

    static {
        try {
            String applicationHome = System.getenv().get(rootDirName.toUpperCase());
            if (applicationHome == null) {
                applicationHome = System.getenv().get(rootDirName);
            }
            if (applicationHome == null || applicationHome.trim().length() == 0) {
                ...
                applicationHome = tempDrive + File.separator + rootDirName;
            }
            defaultFileSystemService = new FileSystemServiceImpl(applicationHome);
        } catch (Exception e) {
    ...
    public FileSystemServiceImpl(final String defaultFileSystemPath) throws IOException {
        ...
        path = local.getPath(defaultFileRoot.getAbsolutePath()+File.separator+"rootDirChildName");
